    ...
    <section id="team" className="py-20 px-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="flex gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-serif text-text-primary mb-1 group-hover:text-crimson-500 transition-colors">
                    {member.name}
                  </h3>
        ...
        >
          ...
          <button className="px-6 py-3 bg-crimson-500 text-white rounded-lg hover:bg-crimson-600 transition-all text-sm font-medium shadow-lg shadow-crimson-500/20">
            View Open Positions →
          </button>
        </motion.div>
      </div>
